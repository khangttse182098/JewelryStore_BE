...
public class DiscountService implements IDiscountService {
    ...
    public void addDiscountInformation(DiscountDTO discountDTO) {
         ...
         discountEntity.setStartDate(dateTimeConverter.covertToDateTimeDTO(discountDTO.getStartDateDTO()));
         discountEntity.setEndDate(dateTimeConverter.covertToDateTimeDTO(discountDTO.getEndDateDTO()));
